...
static int id;
char wq_data[] = "time tasklet data";
...
void kb_wq_handler(struct work_struct *work) 
{
	...
	unsigned long scancode =  kb_work->data; //atomic_long_read( &(kb_work->data));
...
static int __init mod_init(void)
{
	...
	if (request_irq(KEYBOARD_IRQ, interrupt_handler, IRQF_SHARED, "interrupt_with_worqueue", &id))
	{
